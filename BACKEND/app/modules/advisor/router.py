...
async def chat(
    ...
    Context values:
    - "admission"   — JAMB/WAEC/Post-UTME/university admission guidance
    - "career"      — career exploration tied to courses and universities
    ...
    return await AdvisorService(db).chat(
        ...
        context=payload.context or "admission",
